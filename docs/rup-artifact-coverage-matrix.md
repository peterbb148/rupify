...
| Template-driven use-case document | per-use-case status, priorities, flows, secondary scenarios, UI, related artifacts | `full` | `use-case-documents.md` plus canonical use cases/scenarios/trace views | deepen polish under `#123` follow-ons |
| Template-driven scenario document | scenario-level flow, sequence/activity views, artifact references | `full` | `scenario-documents.md` plus canonical scenario objects and supporting trace/views | deepen polish under `#123` follow-ons |
