---
name: specops-discovery
description: Capture software requirements through a structured interview and normalize the answers into the canonical specops-model without inventing missing information.
---
...
- update `specops-model.yaml` as the source of truth
