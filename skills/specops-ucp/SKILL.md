---
name: specops-ucp
description: Produce a deterministic Use Case Point estimate from the canonical SpecOps model and fail clearly when required estimation inputs are missing.
---
