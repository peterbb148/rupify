# SpecOps Feedback from the IT Systems Inventory Example
...
## What This Example Exposes About SpecOps
...
This example surfaced several ambiguities that should become explicit SpecOps guidance:
...
SpecOps should make these ambiguity classes explicit during interview and normalization.
...
interpretation. SpecOps should do a better job of guiding users through UCP classification so the
...
- a standing source of product feedback for how SpecOps should improve
