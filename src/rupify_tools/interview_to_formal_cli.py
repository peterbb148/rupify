"""CLI for generating formal Rupify artifacts directly from an interview fixture."""
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(
        description="Replay an interview fixture and render the formal Rupify artifacts."
    )
